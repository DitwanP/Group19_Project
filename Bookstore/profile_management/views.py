...
def home(request): 
	...
	if request.method == 'POST':
		...
		thisuser = Profile.objects.filter(Username = request.user.username).update(name = fullname, nickName = nickname, Email = email, phoneNumber = phone, Address = address)
	...
	return render (request, 'userProfile/Profiletemplete.html', {'users': users, 'cards': cards, 'addresses': addresses})
